...
?>
		...
		<div id="primary-search-wrapper" class="menu-wrapper">
			<div class="menu-toggle-wrapper">
				<button id="social-search-toggle" class="menu-toggle">
					<span class="menu-label screen-reader-text"><?php echo esc_html_e( 'Search', 'my-music-band' ); ?></span>
				</button>
			</div><!-- .menu-toggle-wrapper -->
	...
	<a id="lichnyj-zal" class="lichnyj-zal" href="/lichnyj-zal">ЛИЧНЫЙ ЗАЛ</a>&nbsp;&nbsp;
	<a class="native-w" href="<?php echo wp_logout_url( home_url() ); ?>"><i class='fas fa-sign-out-alt' title='Выход'></i></a>
		<?php } else { ?>
		<a class="native-w" href="/enter"><i class='fas fa-sign-in-alt' title='Вход'></i></a>
		<?php } ?>
